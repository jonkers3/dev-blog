...
Our goal at the moment is to get something up that we can easily add content and deploy changes to. So we will now head over to Github and do just that.
...
At this point, the blog should be looking good on Github Pages.