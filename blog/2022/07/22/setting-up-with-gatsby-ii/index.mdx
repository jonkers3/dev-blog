...
Due to the nature of our Github Pages setup, we need to make the following change to ensure that all of our images and links are working right. Of course the value here needs to match our Github setup:
