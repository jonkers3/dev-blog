...
This generates some files. The first one to know about is the `gatsby-config.js/ts` file :
...
For the [second part of this post](/2022/07/22/setting-up-with-gatsby-ii), we will concern ourselves with getting our new blog Gatsby blog deployed.
