...
What kind of styling, what plugins, typescript or not, that sort of thing.

We selected MDX support, responsive images, and React Helmet. For styling, we're going to use CSS modules.

This generates some files. The first one to know about is the gatsby-config file:
...
For initial setup, there are a few nice things to do, like:
...
In any case, we need at least [one MDX file with a date](https://raw.githubusercontent.com/jonkers3/dev-blog/master/blog/2022/07/20/setting-up-with-gatsby/index.mdx) to exist in our blog folder.
