...
If your setup is like ours, you are using Typescript and CSS modules. If so, you will want to create a definitions file like this to prevent the TS compiler from finding fault with our CSS module imports.
